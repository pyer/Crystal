  ...
  @@segfault_handler = LibC::SigactionHandlerT.new { |sig, info, data|
    ...
    is_stack_overflow =
      begin
        ...
        System.print_error "Error while trying to determine if a stack overflow has occurred. Probable memory corruption\n"
        false
      end
    ...
    if is_stack_overflow
      ...
      System.print_error "Invalid memory access (signal %d) at address 0x%lx\n", sig, addr
    end
...
module System::SignalChildHandler
