...
describe "Box" do
  ...
  pending "boxing a nilable reference returns the same pointer" do
    a = "foo".as(String?)
    box = Box.box(a)
    box.address.should eq(a.object_id)
  ...
  pending "boxing a nilable value returns the same value" do
    a = 1.as(Int32?)
    box = Box.box(a)
  ...
  pending "boxing nil in a reference-like union returns a null pointer (#11839)" do
  ...
  pending "boxing nil in a value-like union doesn't crash (#11839)" do
