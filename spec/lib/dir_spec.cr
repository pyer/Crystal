...
describe "Dir" do
  ...
  describe "glob" do
    ...
    pending "tests glob with a single pattern with extra slashes" do
      Dir["test////data////dir////*.txt"].sort.should eq [
        datapath("dir", "f1.txt"),
        datapath("dir", "f2.txt"),
        datapath("dir", "g2.txt"),
      ].sort
    ...
    pending "tests with relative path (starts with .)" do
      Dir["./#{Path[datapath].to_posix}/dir/*/"].sort.should eq [
    ...
    pending "tests with relative path starting recursive" do
