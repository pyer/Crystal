...
module Tinytest
  ...
  module Assertions
    ...
    def assert(actual, message = nil, file = __FILE__, line = __LINE__) : Bool
      ...
      raise Tinytest::Assertion.new(msg, __tinytest_file: file, __tinytest_line: line)
    end
    ...
    def assert_raises(message : String? = nil, file = __FILE__, line = __LINE__, &) : Exception
      ...
      raise Assertion.new(message, __tinytest_file: file, __tinytest_line: line)
    end
    ...
    def skip(message = "", file = __FILE__, line = __LINE__) : NoReturn
      raise Tinytest::Skip.new(message.to_s, __tinytest_file: file, __tinytest_line: line)
    end

    def flunk(message = "Epic Fail!", file = __FILE__, line = __LINE__) : NoReturn
      raise Tinytest::Assertion.new(message.to_s, __tinytest_file: file, __tinytest_line: line)
    end
